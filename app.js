(function (window, d3, _, $, BUILDINGS, undefined) {
  ...
  function displayChart(data) {
    ...
    $('svg path').tipsy({ /* tooltip */
      html: true, title: function tooltip(){ return _.template($('#tooltip-template').html(), this.__data__); }
    });
  }
  ...
  function onFilterViewChange() {
    ...
    // TODO: do with enter/exit nodes really, with nice animation. This however is shorter.
    svg.selectAll('path').remove();
    displayChart({children : filterHandler(BUILDINGS, filterType, filterValue) });
  }
  ...
  function init() {
    ...
    arc = d3.svg.arc()
      ...
      .innerRadius(function getInnerRadius() { return radius * 0.2; })
